		...
		<!-- Billing Address -->
			...
			<div class="panel panel-primary">
				...
				<div class="panel-heading">
					...
					<h4 align="center">Billing Address</h4>
				...
				<div class="panel-body">
					...
					<!-- FORM ELEMENT -->
					<sf:form  class="form-horizontal" modelAttribute="address"  method="POST">
						...
						<div class="form-group">		
							<div class="col-md-offset-4 col-md-8">	
								<button type="submit" class="btn btn-primary"
										name="_eventId_shipping">
								 Next -Shipping <span class="glyphicon glyphicon-chevron-right"></span>
								</button>
								<!-- Hidden fields for Billing Address -->
								<sf:hidden path="id"/>
