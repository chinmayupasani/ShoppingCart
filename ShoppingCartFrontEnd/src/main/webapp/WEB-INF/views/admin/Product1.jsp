...
<body>
	<div class="container">
		...
		<c:url var="addAction" value="/manage-product-add?${_csrf.parameterName}=${_csrf.token}"></c:url>
 		<form action="${addAction}" commandName="product" enctype="multipart/form-data" method="post" cssClass="form-horizontal">
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					<form:input type="file" name="image" path="resources/image" cssClass="form-control" />
				</div>
			</div>
			<div class="form-group">
				<td colspan="2"><c:if test="${product.name}">
